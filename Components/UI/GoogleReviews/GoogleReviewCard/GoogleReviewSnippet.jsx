...
function GoogleReviewSnippet({reviewerPics, reviewTitle}) {
  return (
   
    <div className={`${styles.reviewWrapper} mb-16 flex gap-8`}>
    ...
    <div className={`${styles.reivewTitleWrapper}`}>
      ...
      <div
        className={`${styles.ratingWrapper} flex align-center gap-4`}
      >
